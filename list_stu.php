    ...
    function redirectToPage(course) {
      switch(course) {
        case 'engineering_math':
          window.location.href = 'stu_maths.php';
          break;
        case 'os':
          window.location.href = 'stu_os.php';
          break;
        case 'aoa':
          window.location.href = 'stu_aoa.php';
          break;
        case 'dbms':
          window.location.href = 'stu_dbms.php';
          break;
        case 'python':
          window.location.href = 'stu_python.php';
          break;
          case 'microprocessor':
          window.location.href = 'stu_micro.php';
          break;
        default:
          break;
      }
